...
function FormBeasiswa() {
    return (
        <>
            <Navbar />
            <section className="min-h-screen mx-auto flex-col px-6 py-4 mt-5 bg-white shadow">
                <div className="">
                    <form >
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="adress" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" />
